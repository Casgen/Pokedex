...
<body>
    ...
    <nav id="usernavigate" style="position:fixed" class="navbar navbar-default navbar-fixed-top" role="navigation">
        <a class="navbar-brand" href="#"><?php echo $jmeno;?></a>
    ...
    <div id="zobrazeni">
        <nav class="divy" id="pokemonnavigate">
            ...
            <!--typy-->
             <button style="Width:100%;margin-bottom:10px;" class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseTypy" aria-expanded="false" aria-controls="collapseExample">
                Typy
            </button>
            ...
            <!--Slabosti-->
             <button style="Width:100%;margin-bottom:10px;" class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseSlabosti" aria-expanded="false" aria-controls="collapseExample">
                Slabosti
            </button>
        ...
        $dotaz = $spojeni->prepare("SELECT id,nazev,obrazek FROM pokemoni");
                        ...
                        $dotaz->execute();
        echo"<div id='ro' class='row'>";   
        $pokemon_count = 0;              
        while($dotaz->fetch()){   
            $pokemon_count++;       
        echo "<a class='obrazky' href='detail.php?id=$id'><img class='obrPokemona' src='$obrazek' height='200px' width='200px'><h3  class='nazevPokemona'>Text</h3></a>";
        if($pokemon_count==3){
            echo "</div><div id='ro' class='row'>";
            $pokemon_count=0;
        }
        }
        ?>
